document.getElementById("gioithieu").addEventListener("click",function(){
    window.open('https://gokisoft.com', '_blank', 'toolbar=0,location=0,menubar=0');
});
document.getElementById("tintuc").addEventListener("click",function(){
    window.open('https://ziczacgroup.com', '_blank', 'toolbar=0,location=0,menubar=0');
});
